...
Public Class rptEnrollmentForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SRS.rptEnrollmentForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEnrollmentForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEnrollmentForm = New rptEnrollmentForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
